			...
			<tbody>
				<?php foreach ( $table['bookings'] as $booking ) : ?>
					...
					<tr>
						...
						<td class="booking-end-date"><?php echo esc_html( $booking->get_start_date( null, null, wc_should_convert_timezone( $booking ) ) ); ?></td>
						...
						<td><?php echo customer_all_ratings($booking->get_id()); ?></td>
					</tr>
				<?php endforeach; ?>
			</tbody>
		</table>
