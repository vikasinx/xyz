				...
				foreach($booking_ids as $booking_id) {
					/*foreach($booking_id as $booking_id2) {*/
						...
						if ($booking->get_status() == 'complete') {
							...
							echo '<div><span style="margin-right:10px;"></span><a class="customer_link" href=?bid=' . $booking_id . '>Booking ID #' . $booking_id . '</a><span style="margin-left:10px;"><strong>Booking Dates: </strong></span><span class="start_date">' . $start_date . '  -  </span><span class="end_date">' . $end_date . '</span></div>';
						}
					/*}*/
				}
